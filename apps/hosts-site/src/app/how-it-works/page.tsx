...
function PhaseLabel({ num, label }: { num: string; label: string }) {
  return (
    <div className="flex items-baseline gap-3 mb-3">
      <span
        className="text-2xl"
        style={{ fontFamily: "var(--font-barlow)", fontWeight: 800, color: "var(--accent)" }}
      >
        Phase {num}
      </span>
      <span
  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-[1100px] px-6 py-8">
        {/* Phase 1 */}
        <div
          className="rounded-sm border p-8 md:p-12 mb-6"
        ...
        >
          ...
          <p className="text-base leading-relaxed max-w-[600px] mb-8" style={{ color: "var(--text-secondary)" }}>
            ...
            most of it. We tell you exactly what we need — you will not be guessing or filling out lengthy
            forms.
          </p>
          <div className="mb-4">
            <p
        ...
        {/* Phase 4 */}
        <div
          className="rounded-sm border p-8 md:p-12 mb-16"
          style={{ background: "var(--bg-surface)", borderColor: "var(--border)" }}
        >
