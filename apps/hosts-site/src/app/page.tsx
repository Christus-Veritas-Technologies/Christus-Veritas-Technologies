...
function PrimaryBtn({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <Link
      href={href}
      className="inline-block rounded-[4px] px-8 py-3.5 text-sm font-bold tracking-wide transition-opacity hover:opacity-90"
      style={{
...
export default function HomePage() {
  return (
    <>
      {/* ── HERO ─────────────────────────────────────────────────────────── */}
      <section
        className="relative flex items-center min-h-[100svh] overflow-hidden"
        style={{ background: "var(--bg-primary)" }}
      >
        {/* Background watermark chevron */}
        <div
          className="absolute right-0 top-1/2 -translate-y-1/2 pointer-events-none select-none"
          aria-hidden="true"
          style={{ opacity: 0.04 }}
        >
          <svg width="560" height="420" viewBox="0 0 560 420" fill="none">
            <path d="M60 380L280 120L500 380" stroke="var(--text-primary)" strokeWidth="24" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M60 260L280 0L500 260" stroke="var(--text-primary)" strokeWidth="24" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>

        <div className="relative mx-auto max-w-[1100px] px-6 py-24 md:py-32">
          {/* Launch offer */}
          <div
            className="inline-block text-xs tracking-[0.1em] uppercase px-3 py-1.5 rounded-sm mb-8"
          ...
          <h1
            className="text-5xl md:text-7xl leading-[1.05] mb-6 max-w-2xl"
            style={{ fontFamily: "var(--font-playfair)", fontWeight: 400, color: "var(--text-primary)" }}
          >
            You&rsquo;re losing R6,000
            <br />every month.
            <br />Not to bad business.
            <br />To Booking.com.
          </h1>

          <p
            className="text-base md:text-lg leading-relaxed max-w-[560px] mb-10"
            style={{ color: "var(--text-secondary)", fontFamily: "var(--font-inter)" }}
          >
            Every booking through their platform costs you 15 to 20 percent. That is your profit, handed to
            a platform that owns your guest relationship and charges you again every time that same person
            comes back. CVT Hosts gives you a direct booking system built around your property — so guests
            book with you, pay you, and come back to you.
          </p>
      ...
      <section style={{ background: "var(--bg-surface)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)" }}>
        <div className="mx-auto max-w-[1100px] px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 md:divide-x"
        ...
        >
          {[
            ...
            <div key={i} className="flex flex-col items-start gap-3 md:px-10 first:pl-0 last:pr-0">
      ...
      <section className="mx-auto max-w-[1100px] px-6 py-24">
        ...
        <p className="text-base leading-relaxed max-w-[640px] mb-10" style={{ color: "var(--text-secondary)" }}>
          You listed your property to get bookings. That worked. But every year you stay on the platform,
          the arrangement costs you more — not just in commission, but in guests you cannot contact,
          relationships you cannot build, and revenue that belongs to you but never arrives.
        </p>

        <div className="mb-10">
          <DangerCallout>
            A guest house doing R30,000 per month in bookings pays up to R6,000 in commission every single
            month. That is R72,000 a year — for guests who will book through the same platform again next
            time and cost you again.
          </DangerCallout>
        </div>
      ...
      <section className="mx-auto max-w-[1100px] px-6 py-24">
        ...
        <p className="text-base leading-relaxed max-w-[640px] mb-12" style={{ color: "var(--text-secondary)" }}>
          CVT Hosts builds your property a complete direct booking system — a professional website, a live
          availability calendar, upfront payment collection via PayFast, a full bookings database, and a
          shareable booking link you can put anywhere. Guests book directly with you. Money goes straight to
          your account. Everything is recorded, tracked, and yours.
        </p>
          ...
          {[
            {
              ...
              body: "Professional, mobile-first, built for your property. Your rooms, your rates, your brand — not a listing on someone else&rsquo;s platform.",
            },
            {
            ...
            },
            {
              ...
              body: "South Africa&rsquo;s most trusted payment platform. Card and EFT. Money goes straight to your account at the point of booking — no platform holding it, no payout delays.",
            },
            {
              Icon: WhatsappIcon,
      ...
      <section className="mx-auto max-w-[1100px] px-6 py-24">
        ...
        <SectionHeadline>
          Pick where you are.
          <br />We will get you where you want to be.
        </SectionHeadline>
          ...
          {[
            {
              name: "Get Found",
              tier: "Starter",
              tagline: "Professional website and direct booking infrastructure.",
              price: "R7,000",
              monthly: "R499/month",
              gold: false,
            },
            {
              name: "Take Direct Bookings",
              tier: "Growth",
              tagline: "A complete booking and payment system with reports.",
              price: "R15,000",
              monthly: "R899/month",
              gold: true,
            },
            {
              ...
              tier: "Full Stack",
              tagline: "Everything — including a WhatsApp AI Agent that books, replies, and collects payment autonomously.",
              price: "R30,000",
            ...
            <div
              ...
              style={{
                ...
                borderColor: gold ? "var(--accent)" : "var(--border)",
              }}
            >
              {gold && (
        ...
        <div className="mx-auto max-w-[1100px] px-6 py-24">
          ...
          >
            ...
            >
              ...
              website. We had no contact details for a single guest. CVT Hosts changed that in a
              week.&rdquo;
            </blockquote>
            <cite
