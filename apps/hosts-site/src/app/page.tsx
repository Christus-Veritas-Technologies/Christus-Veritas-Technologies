...
// Curated SA-style guest house images from Unsplash
const HERO_IMAGES = [
  {
  ...
  {
    src: "https://images.unsplash.com/photo-1596178065887-a7f16ce9b4a4?w=420&h=320&fit=crop&auto=format",
...
export default function HomePage() {
  return (
    <>
      ...
      >
        {/* Floating property images — visible on large screens only */}
        {HERO_IMAGES.map((img) => (
          <div
            key={img.alt}
      ...
      <section style={{ background: "var(--bg-surface)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)" }}>
        <div className="mx-auto max-w-[1100px] px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8"
      ...
      <section className="mx-auto max-w-[1100px] px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          {[
            ...
            <div key={tier} className="rounded-xl border flex flex-col overflow-hidden" style={{ background: "var(--bg-surface)", borderColor: gold ? "var(--accent)" : "var(--border)" }}>
