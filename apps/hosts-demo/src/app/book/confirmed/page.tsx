            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-[var(--accent)] font-[family-name:var(--font-barlow)]">
            ...
            <CardContent className="p-5">
              ...
              <ul className="space-y-2 text-sm text-[var(--text-secondary)]">
                {[
                  ...
                  "We'll reach out if we need anything before your arrival.",
                  "Check-in is from 14:00. Let us know if you'll be arriving late.",
