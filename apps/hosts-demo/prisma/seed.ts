import { PrismaClient, BookingStatus } from "../src/generated/prisma";
  ...
  const rooms = await Promise.all([
    ...
    prisma.room.create({
      data: {
        ...
        description:
          "First floor with unobstructed views across the Bloemfontein skyline. King bed, en-suite bathroom with rainfall shower, and a reading chair by the window.",
        bedType: "1 King",
        capacity: 2,
        ratePerNight: 1200,
        amenities: ["Full Breakfast", "Free Wi-Fi", "Private Bathroom", "Secure Parking", "City View", "Air Conditioning"],
        photos: [
    ...
    prisma.room.create({
      data: {
        ...
        description:
          "Our flagship room. King bed with premium linen, a separate lounge area, en-suite with freestanding bath and shower, and a private balcony. For guests who want the best Thornfield has to offer.",
