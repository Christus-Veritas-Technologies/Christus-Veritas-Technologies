...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen flex">
        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 bg-[#7C3AED] hover:bg-[#6D28D9] text-white font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          >
            ...
            <Link href="/auth/signup" className="text-[#7C3AED] hover:text-[#6D28D9] font-medium">
              Sign up for Free
            </Link>
          </motion.p>
        </motion.div>
      ...
      <div className="hidden lg:flex flex-1 relative bg-gradient-to-br from-[#4169E1] to-[#7C3AED]">
        <motion.div
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="text-center">
              <motion.p
                ...
                className="text-3xl font-bold text-[#7C3AED]"
              >
                500+
              </motion.p>
            ...
            <div className="text-center border-x border-gray-200">
              <motion.p
                ...
                className="text-3xl font-bold text-[#4169E1]"
              >
                10K+
              </motion.p>
